...
<script>
export default {
	name: 'AdminProductMasterAdvantageRead',
	...
	watch: {},
	created() {
		this.models.thumbnail = this.readItem.thumbnail_url
			? {
					text: this.readItem.thumbnail_url,
					button: {
						text: '링크보기',
						color: 'primary',
						link: this.readItem.thumbnail_url,
					},
			  }
			: {}
