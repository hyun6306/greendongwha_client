<template>
	...
	>
		<v-btn
			...
			:key="i"
			height="38"
			:class="`toggle_button_04_${i}`"
			class="mr-5 toggle_normal_btn"
...
export default {
	...
	methods: {
		selectItem(item, i) {
			this.model = i
			// console.log('selectItem', item, i)
		},
		// 선택 button 가로 스크롤
		horizontalSelectScroll(i) {
			const selectButton = document.querySelector(`.toggle_button_04_${i}`)
...
.toggle_active_btn {
	...
	border: 1px solid $color_green1 !important;
