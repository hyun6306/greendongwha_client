...
export default {
	...
	methods: {
		...
		async getList(params = { notice_kind: '0' }) {
			this.loading = true
		...
		searchItems() {
			...
			const params = {
				notice_kind: this.models.division?.value || '0', // 0= 공지 | 뉴스 1 = 공지 | 2 = 뉴스
